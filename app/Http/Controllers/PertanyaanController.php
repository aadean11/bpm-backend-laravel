    ...
    public function save(Request $request)
{
    // Validasi input
    $request->validate([
        'pty_pertanyaan' => 'required|string|max:50|unique:bpm_mspertanyaan,pty_pertanyaan', // Validasi untuk pertanyaan
    ], [
        'pty_pertanyaan.required' => 'Pertanyaan harus diisi.',
        'pty_pertanyaan.max' => 'Pertanyaan tidak boleh lebih dari 255 karakter.',
        'pty_pertanyaan.unique' => 'Pertanyaan sudah ada, silakan pilih pertanyaan lain.',
    ]);
    ...
    // Simpan data karyawan terkait ke dalam tabel DetailBankPertanyaan
    ...
    // Redirect ke halaman Pertanyaan.index dengan pesan sukses
