...
<body>
    ...
    <div class="content mt-5">
                    ...
                    @forelse ($skala_penilaian as $index => $skala)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('SkalaPenilaian.edit', $skala->skp_id) }}"
                                type="button" class="btn btn-warning"><i class="fas fa-edit"></i> Edit</a>
        ...
        <!-- Modal untuk Tambah Skala Penilaian -->
        <div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Tambah Skala Penilaian</h1>
                    ...
                    <form action="{{ route('SkalaPenilaian.save') }}" method="post">
                        ...
                        <div class="modal-body">
                            <div>
                                <label for="skp_skala">Skala <span style="color:red">*</span></label>
                                <input type="number" name="skp_skala" placeholder="Masukkan Skala"
                                    class="form-control" required>
                            </div>
                            <div>
                                <label for="skp_deskripsi">Deskripsi <span style="color:red">*</span></label>
                                <textarea name="skp_deskripsi" placeholder="Masukkan Deskripsi"
                                    class="form-control" required></textarea>
                            </div>
                            <div>
                                <label for="skp_tipe">Tipe <span style="color:red">*</span></label>
                                <input type="text" name="skp_tipe" placeholder="Masukkan Tipe"
                                    class="form-control" required>
                            </div>
                        </div>
